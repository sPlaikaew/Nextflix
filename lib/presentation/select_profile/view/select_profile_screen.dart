...
import 'package:nextflix/presentation/select_profile/view/widgets/profile_widget.dart';
...
class _SelectProfileScreenState extends State<SelectProfileScreen> {
  ...
  Widget _buildContent(List<Profile> profiles,Translations localizations) {
    return Center(
      child: Column(
